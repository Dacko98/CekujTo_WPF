    ...
    public class FilmEntity : EntityBase
    {
        ...
        private sealed class FilmEntityEqualityComparer : IEqualityComparer<FilmEntity>
        {
            public bool Equals(FilmEntity x, FilmEntity y)
            {
                ...
                return x.ID == y.ID && x.OriginalName == y.OriginalName && x.CzechName == y.CzechName && x.Genre == y.Genre && x.TitleFoto == y.TitleFoto && x.Country == y.Country && x.Duration.Equals(y.Duration) && x.Description == y.Description && Equals(x.Reviews, y.Reviews) && Equals(x.Directors, y.Directors) && Equals(x.Actors, y.Actors);
            }
